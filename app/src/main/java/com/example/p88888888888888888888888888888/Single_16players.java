...
public class Single_16players extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_16players);

        next16= findViewById(R.id.goToFirstFinal);
       ...
       next16.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
               ...
               if (playerName1.equals("") || playerName2.equals("") ||
                   ...
                   Intent in4 = new Intent(Single_16players.this, SingleFirstRound.class);
