...
public class Double16Comput8Lose8Win extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_double16_comput8_lose8_win);
        ...
        firstWinner = findViewById(R.id.goTo_8_8);
        ...
        final_16 = findViewById(R.id.goTo_8_8_C);
        final_16.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(Double16Comput8Lose8Win.this, DoubleElim4win8Loos.class);
                ...
                if (result1 < result2) {
                    i.putExtra("player9", pl);
                }
                else if (result1 > result2) {
                    i.putExtra("player9", p2);
                }

                if (result3 < result4) {
                    i.putExtra("player10", p3);
                }
                else  if (result3 > result4) {
                    i.putExtra("player10" ,p4);
                }



                if (result5 < result6) {
                    i.putExtra("player11", p5);
                }
                else if (result5 > result6) {
                    i.putExtra("player11", p6);
                }


                if (result7 < result8) {
                    i.putExtra("player12", p7);
                }
                else if (result7 > result8) {
                    i.putExtra("player12", p8);
                }



                if (result9 < result10) {
                    i.putExtra("player13", p9);
                }

                else if (result9 > result10) {
                    i.putExtra("player13", p10);
                }



                if (result11 < result12) {
                    i.putExtra("player14", p11);
                }
                else if (result11 > result12) {
                    i.putExtra("player14", p12);;
                }
                ...
                if (result13 < result14) {
                    i.putExtra("player15", p13);
                }
                else if (result13 > result14) {
                    i.putExtra("player15", p14);
                }



                if (result15 < result16) {
                    i.putExtra("player16", p15);
                }
                else if (result15 > result16) {
                    i.putExtra("player16", p16);
                }
