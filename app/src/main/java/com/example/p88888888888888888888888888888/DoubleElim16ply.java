...
public class DoubleElim16ply extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_double_elim16ply);

        next16= findViewById(R.id.goTo_16_C);
        ...
        next16.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (playerName1.equals("") || playerName2.equals("") ||
                    ...
                    Intent in4 = new Intent(DoubleElim16ply.this, DoubleElim16Compuit.class);
