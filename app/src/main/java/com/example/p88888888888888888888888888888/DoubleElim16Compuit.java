...
public class DoubleElim16Compuit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_double_elim16_compuit);
        ...
        firstWinner = findViewById(R.id.eight_W_E_L);
        ...
        final_16 = findViewById(R.id.getEight_W_L);
        final_16.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(DoubleElim16Compuit.this, Double16Elm8Los8Win.class);
